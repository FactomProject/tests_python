...
class CLITestsEntries(unittest.TestCase):
    ...
    def test_make_entry_return_entry_hash(self):
        ...
        self.cli_chain.make_chain_from_binary_file(self.entry_credit_address1000, path, external_id_list=names_list)
        ...
        factom_flags_list = ['-E']
        entry_hash = self.cli_chain.add_entry_to_chain(self.entry_credit_address1000, self.path, external_id_list=names_list, flag_list=factom_flags_list)
    ...
    def test_raw_entry(self):
        ...
        names_list = ['-n', name_1, '-n', name_2]
        factom_flags_list = ['-E']
        entry_hash = self.cli_chain.make_chain_from_binary_file(self.entry_credit_address1000, path, external_id_list=names_list, flag_list=factom_flags_list)
    ...
    def test_verify_entry_costs(self):
        ...
        with open('output_file', 'wb') as fout:
            ...
            self.path = fout.name
        text = self.cli_chain.make_chain_from_binary_file(self.entry_credit_address1000, self.path, external_id_list=chain_names_list)
        ...
        # self.assertIn("Entry cannot be larger than 10KB", self.cli_chain.add_entry_to_chain(self.entry_credit_address1000, self.path, external_id_list=names_list))
    ...
    def test_force_make_entry_with_hex_external_chain_id(self):
        ...
        text = self.cli_chain.make_chain_from_binary_file(self.entry_credit_address1000, path, external_id_list=chain_names_list)
    ...
    def test_quiet_make_entry(self):
        ...
        self.cli_chain.make_chain_from_binary_file(self.entry_credit_address1000, path, external_id_list=chain_names_list)
    ...
    def test_compose_entry(self):
        ...
        with open('output_file', 'wb') as fout:
            ...
            self.path = fout.name
        text = self.cli_chain.make_chain_from_binary_file(self.entry_credit_address1000, self.path,
        ...
        with open('output_file', 'wb') as fout:
            fout.write(os.urandom(10))
            self.path = fout.name
        self.assertTrue("message" and "entry" in self.cli_chain.compose_entry_from_binary_file(
        ...
        with open('output_file', 'wb') as fout:
            fout.write(os.urandom(10))
            self.path = fout.name
        self.assertTrue("message" and "entry" in self.cli_chain.compose_entry_from_binary_file(self.entry_credit_address1000, self.path, external_id_list=entry_names_list))
        ...
        with open('output_file', 'wb') as fout:
            fout.write(os.urandom(10))
            self.path = fout.name
        self.assertTrue("message" and "entry" in self.cli_chain.compose_entry_from_binary_file(self.entry_credit_address1000, self.path, external_id_list=entry_names_list, flag_list=factom_flags_list))
