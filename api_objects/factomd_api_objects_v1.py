...
class FactomApiObjectsv1():
    data = read_data_from_json('addresses.json')
    factomd_address = data['factomd_address']

    def send_get_request_with_params_dict(self, method, params):
        url = 'http://'+self.factomd_address+'/v1/'+ method + '/'+ params
    ...
    def send_get_request_with_method(self, method):
        url = 'http://' + self.factomd_address + '/v1/' + method
        print url
        #headers = {'content-type': 'text/plain'}
    ...
    def get_directory_block_by_keymr(self, keymr):
        ...
        """
        blocks = json.loads(self.send_get_request_with_params_dict('directory-block-by-keymr',keymr))
        return blocks["EntryBlockList"][0]
    ...
    def get_heights(self):
        ...
        '''
        blocks = json.loads(self.send_get_request_with_method('directory-block-height'))
