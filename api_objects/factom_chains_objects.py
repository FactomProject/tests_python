...
class FactomApiChainObjects():
    ...
    chainID ="e9ef3fd9c11deffbf771142ef0560fb5c087eca0c913107512db6539bae25ce3" #chain name thisIsAChainName
    entryContent = "hello world"
    externalIDs = ["extid1","anotherextid1","newextid","newextid2"]
