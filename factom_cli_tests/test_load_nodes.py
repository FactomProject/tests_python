    ...
    def test_make_chain_and_check_balance(self):
        ...
        for i in xrange(10):
            ...
            for i in range(80):
                ...
                chain_id = self.factom_chain_object.make_chain_from_binary_file(self.entry_creds_wallet1, path,
                                                                                names_list,
                ...
                for i in range(120):
                    ...
                    self.factom_chain_object.add_entry_to_chain(self.entry_creds_wallet1, path, names_list,
                                                                flag_list=chain_flags_list)
            time.sleep(5)
            os.remove(path)
        time.sleep(30)
