...
class FactomHeightTests(unittest.TestCase):
    ...
    factomd_address_custom_list = [data['factomd_address'], data['factomd_address_0'], data['factomd_address_1'], data['factomd_address_2'], data['factomd_address_3'],
                                   data['factomd_address_4'], data['factomd_address_5']
    ...
    def test_current_directory_block_height_of_all_nodes(self):
        ...
        print "server - %s, height - %s" % (self.factomd_address, directory_block_head_1)
        for x in range(0, 1000):
            for factomd_address_custom in self.factomd_address_custom_list:
                ...
                print "server - %s, height - %s" % (factomd_address_custom, directory_block_head_2)
    ...
    def notest_get_heights_of_all_nodes(self):
        ...
        for factomd_address_custom in self.factomd_address_custom_list:
            ...
            print "server - %s, height - %s" % (factomd_address_custom,get_height_2)
