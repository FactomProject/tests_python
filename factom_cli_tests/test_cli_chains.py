...
class FactomChainTests(unittest.TestCase):
    ...
    def test_make_correct_chain_with_not_enough_ec(self):
        ...
        names_list = ['-n', '2', '-n', '2']
        self.assertTrue(
            'Not enough Entry Credits' in self.factom_chain_object.make_chain_from_binary(self.entry_creds_wallet2,
                                                                                          path, names_list))
    ...
    def test_force_make_chain(self):
        ...
        tx_id = self.factom_chain_object.make_chain_from_binary(self.entry_creds_wallet2, path, names_list, flag_list=factom_flags_list)
    ...
    def test_quiet_make_chain(self):
        ...
        names_list = [ex_id_flag, name_1, ex_id_flag, name_2]
        factom_flags_list = [' -q']
        self.factom_chain_object.make_chain_from_binary(self.entry_creds_wallet2, path, names_list, flag_list=factom_flags_list)
