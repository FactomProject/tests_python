...
class FactomChainTests(unittest.TestCase):
    ...
    def test_make_chain_that_already_exists(self):
        ...
        self.assertTrue('already exist' in self.factom_chain_object.compose_chain_from_binary_file(self.entry_credit_address100, path, names_list), "Duplicate chain not detected")
