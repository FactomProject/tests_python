...
class FactomLoadNodes(unittest.TestCase):
    ...
    def test_make_chain_and_check_balance(self):
        ...
        # increase ENTRIES_PER_BLOCK to decrease sleep time between entries
        # works in conjunction with BLOCKTIME variable in shared_test_dat.json
        ...
        for i in xrange(20):
            ...
            for i in range(80):
                ...
                for i in range(120):
                    ...
                    if not CONTINUOUS: time.sleep(float(self.data['BLOCKTIME']) / float(ENTRIES_PER_BLOCK) * 0.2)
