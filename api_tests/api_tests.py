...
class FactomChainTests(unittest.TestCase):
    ...
    def ntest_directory_blocks(self):
    ...
    def ntest_get_heights(self):
        self.assertTrue('entryheight' in self.factom_api.get_heights())

    def ntest_get_blocks_by_heights(self):
    ...
    def test_get_current_minute(self):
        ...
        print (get_data_dump_from_nonansible_server(self.factomd_address))
